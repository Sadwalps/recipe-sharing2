                ...
                <div className='container-fluid mt-4 mb-4 d-lg-none d-md-none d-block'>
                  <div className="row">
                    ...
                    <div className="col-md-8">
                      ...
                      <button className='btn btn-lg btn-success rounded py-3 w-100 mt-2' style={{ fontWeight: "bold", position: "relative" }}><FontAwesomeIcon icon={faUser} className='me-3' />Users {allUsersDetails.map((item, index) => (<div className='rounded  bg-light fs-5 px-2 text-success' style={{ position: "absolute", top: "1px", right: "1px", fontWeight: "bold" }} >{index + 1}</div>))}</button>
