        ...
        <div className='container-fluid'>
          <div className="row">
            ...
            <div className="col-lg-10 col-md-10 col-12 p-0 ">
              ...
              <div className='d-flex justify-content-between align-items-center px-3 bg-dark' style={{ minHeight: "11vh" }}>

                <div className='d-flex justify-content-center align-items-center gap-3 w-25' style={{ minHeight: "10vh" }}>
                  <img className='d-lg-none d-md-none d-block' src="https://cdn-icons-png.freepik.com/512/10840/10840480.png" alt="app img" style={{ height: "50", width: "50px" }} />
